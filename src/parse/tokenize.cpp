...
/*   Updated: 2025/06/26 16:05:48 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	assign_token_type(t_vectok &tokens)
{
	...
	std::vector<std::string>	keys = {"listen", "host", "server_name", "error_page", "path", "root", "index", "return", "alias", "timeout", "upload_store", "methods", "cgi_path", "max_body"};
